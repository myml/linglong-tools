...
type ApiApiV1ReposGetRequest struct {
	ctx context.Context
	ApiService *ClientAPIService
}

func (r ApiApiV1ReposGetRequest) Execute() (*ApiV1ReposGet200Response, *http.Response, error) {
	return r.ApiService.ApiV1ReposGetExecute(r)
}

/*
ApiV1ReposGet 查看仓库列表

returns repository mode and resolve all branches

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiApiV1ReposGetRequest
*/
func (a *ClientAPIService) ApiV1ReposGet(ctx context.Context) ApiApiV1ReposGetRequest {
	return ApiApiV1ReposGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return ApiV1ReposGet200Response
func (a *ClientAPIService) ApiV1ReposGetExecute(r ApiApiV1ReposGetRequest) (*ApiV1ReposGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ApiV1ReposGet200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClientAPIService.ApiV1ReposGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/repos"
