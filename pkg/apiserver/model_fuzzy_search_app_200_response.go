...
// checks if the FuzzySearchApp200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FuzzySearchApp200Response{}

// FuzzySearchApp200Response struct for FuzzySearchApp200Response
type FuzzySearchApp200Response struct {
...
func NewFuzzySearchApp200Response() *FuzzySearchApp200Response {
	this := FuzzySearchApp200Response{}
	return &this
}
...
func (o FuzzySearchApp200Response) MarshalJSON() ([]byte, error) {
...
func (o FuzzySearchApp200Response) ToMap() (map[string]interface{}, error) {
...
type NullableFuzzySearchApp200Response struct {
	value *FuzzySearchApp200Response
	isSet bool
}

func (v NullableFuzzySearchApp200Response) Get() *FuzzySearchApp200Response {
	return v.value
}

func (v *NullableFuzzySearchApp200Response) Set(val *FuzzySearchApp200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableFuzzySearchApp200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableFuzzySearchApp200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFuzzySearchApp200Response(val *FuzzySearchApp200Response) *NullableFuzzySearchApp200Response {
	return &NullableFuzzySearchApp200Response{value: val, isSet: true}
}

func (v NullableFuzzySearchApp200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFuzzySearchApp200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
